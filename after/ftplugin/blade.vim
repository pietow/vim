...
setlocal suffixesadd=.blade.php,.php,.vue
" setlocal includeexpr=substitute(v:fname,'\\.','/','g')
setlocal includeexpr=B(v:fname)
setlocal path+=resources/views;
setlocal path+=resources/js/components/;
setlocal path+=resources/js/components/gallery;
